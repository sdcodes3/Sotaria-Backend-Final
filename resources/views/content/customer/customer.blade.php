                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" class="more-link" data-customer-id="{{$customersdata->id}}" style="color: #939EAA !important;">More</a>

                                <!-- <a href="#" class="more-link" data-toggle="modal" value="{{$customersdata->id}}" data-target="#moreDetailsModal" style="color: #939EAA !important;">More</a> -->
...
<!-- END ADD Customers -->
<div class="modal fade " id="allDetails" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header text-white " style="background-color: #104E9E;">
                    <h1 class="modal-title fs-4 fw-bold"> All Details</h1>
                    <button data-bs-dismiss="modal" class="btn">
                        <img src="{{asset('img/icon-close.svg')}}" alt="">
                    </button>
                </div>
                <div class="modal-body">
                    <div class="row p-3 g-0" style="color: #92959A;">
                        <div class="row g-4 m-0">
                            <div class="col-12 col-md">
                                <div class="label">Full Name</div>
                                <div class="name">Mansi</div>
                            </div>
                            <div class="col-12 col-md">
                                <div class="label">Email ID</div>
                                <div class="name">User12@gmail.com</div>
                            </div>
                        </div>
                        <div class="row g-4 m-0">
                            <div class="col-12 col-md">
                            ...
                            <div class="col-12 col-md">
                                ...
                                <div class="name">+91 9651626311</div>
                            </div>
                        </div>
                        <div class="row g-4 m-0">
                            <div class="col-12 col-md">
                            ...
                            <div class="col-12 col-md">
                                ...
                                <div class="name">12/12/96</div>
                            </div>
                        </div>
                        <div class="row g-4 m-0">
                            <div class="col-12 col-md">
                                <div class="label">House No. / Building Name</div>
                                <div class="name">A-15 Landmark</div>
                            </div>
                            <div class="col-12 col-md">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        // Get a reference to the "More" links by class name
        var moreLinks = document.querySelectorAll('.more-link');

        // Add a click event listener to each "More" link
        moreLinks.forEach(function (link) {
            link.addEventListener('click', function (e) {
                e.preventDefault();

                // Get the customer ID from the "data-customer-id" attribute
                var customerId = link.getAttribute('data-customer-id');

                // Fetch customer data based on the customer ID (You may need an AJAX request here)
                // Replace the following lines with your actual data fetching logic

                // Simulate fetching data with a setTimeout (replace with your AJAX call)
                setTimeout(function () {
                    var customerData = {
                        full_name: 'Mansi Dodiua',
                        email: 'User12@gmail.com',
                        occupation: 'Agent',
                        mobile_no: '+91 9651626311',
                        gender: 'Female',
                        date_of_birth: '12/12/96',
                        house_building_name: 'A-15 Landmark',
                        road: 'Road Name',
                        country: 'India',
                        city: 'Mumbai',
                        district: 'Mumbai'
                    ...
                    document.querySelector('.modal-title').textContent = 'All Details'; // Set modal title
                    document.querySelector('.name').textContent = customerData.full_name;
                    document.querySelector('.email').textContent = customerData.email;
                    document.querySelector('.occupation').textContent = customerData.occupation;
                    document.querySelector('.mobile-no').textContent = customerData.mobile_no;
                    document.querySelector('.gender').textContent = customerData.gender;
                    document.querySelector('.date-of-birth').textContent = customerData.date_of_birth;
                    document.querySelector('.house-building-name').textContent = customerData.house_building_name;
                    document.querySelector('.road').textContent = customerData.road;
                    document.querySelector('.country').textContent = customerData.country;
                    document.querySelector('.city').textContent = customerData.city;
                    document.querySelector('.district').textContent = customerData.district;

                    // Show the modal
                    var modal = new bootstrap.Modal(document.getElementById('allDetails'));
                    modal.show();
                }, 1000); // Simulated delay for data fetching (adjust as needed)
            });
        });
    });
</script>
